...
class App extends Component {
  ...
  componentDidMount() {
    if (cookie.load("jwt")) {
      fetch('https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/current_user', {
        method: 'GET',
        credentials: 'include',
    ...
    fetch("https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/locations", {
      method: 'GET',
      credentials: 'include'
    })
      .then(res => res.json())
  ...
  handleUserLogOut = (event) => {
    ...
    if (r == true) {
      fetch('https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/users/logout', {
        method: 'DELETE',
        credentials: 'include'
      })
  ...
  handleCreateAccountSubmit = (event) => {
    ...
    fetch("https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/users", {
      credentials: 'include',
      method: "POST",
  ...
  handleLoginSubmit = (event) => {
    event.preventDefault()
    fetch('https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/users/login', {
      method: "POST",
      credentials: 'include',
      headers: {
