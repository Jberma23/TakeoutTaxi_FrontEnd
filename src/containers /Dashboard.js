...
class DashBoard extends Component {
    ...
    componentDidMount() {
        fetch(" https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/trucks", {
            credentials: 'include',
    ...
    handleFavoriteDelete = (event, truck) => {
        let t = this
        fetch(` https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/favorites/${truck.favorites[0].id}`, {
            credentials: 'include',
            method: "DELETE",
    ...
    handleFavorite = (event, truck) => {
        fetch(' https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/favorites', {
            credentials: 'include',
            method: "POST",
            headers: {
            ...
            .then(res => {
                ...
                fetch(` https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/updates
                `, {
                    method: "POST",
                    credentials: 'include',
                    headers: {
    ...
    handleRate = (e, { rating, maxRating }, truck) => {
        this.state.currentUser.ratings.includes(truck.id) ?
            fetch(` https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/rating/${truck.rating.id}`, {
                method: "PATCH",
                credentials: 'include',
                headers: {
                    "Content-Type": "application/json",
            ...
            :
            fetch(' https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/ratings', {
                credentials: 'include',
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
    ...
    handleCommentSubmit = (event, truck, currentUser) => {
        ...
        return truck.reviews.map((e) => e.reviewer_id).includes(currentUser) ?
            fetch(` https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/reviews/${truck.reviews[0].id}`, {
                credentials: 'include',
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
            ...
            :
            fetch(' https://cors-anywhere.herokuapp.com/https://takeouttaxi.herokuapp.com/reviews', {
                credentials: 'include',
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
