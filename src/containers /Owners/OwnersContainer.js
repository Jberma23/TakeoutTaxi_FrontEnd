...
class OwnersContainer extends Component {
    ...
    handleCheckIn = (props) => {
        ...
        fetch(`https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/trucks/${props.truck.id}`, {
            credentials: 'include',
            method: "PATCH",
            headers: {
    ...
    handleCheckInForm = (event, truck) => {
        ...
        Geocode.fromAddress(event.target.firstChild.lastChild.firstChild.value).then(
            response => {
                ...
                fetch(`https://cors-escape.herokuapp.com/https://takeouttaxi-backend.herokuapp.com/trucks/${truck.id}`, {
                    credentials: 'include',
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
