...
class CustomerTruckContainer extends Component {
    ...
    renderAllTrucks = () => {
        ...
        return this.props.trucks.map(truck => <Truck handleCommentSubmit={this.props.handleCommentSubmit} handleFavorite={this.props.handleFavorite} currentUser={this.props.currentUser} handleRate={this.props.handleRate} key={truck.id} truck={truck} />)
    }
